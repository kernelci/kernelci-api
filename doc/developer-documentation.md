...
All the `jobs` defined [here](https://github.com/kernelci/kernelci-pipeline/blob/main/config/pipeline.yaml#L193) would run on the newly added tree until specified otherwise.
